...
<div id="cont_right">
	...
	<div class="form_div">
	<div class="location_title"><? if($board_id == 'contents') {echo '컨텐츠관리';}else if($board_id == 'writer') {echo '여행작가 게시물';}else if($board_id == 'notice') {echo '이벤트/공지';}else{echo '게시 컨텐츠';} ?></div>
		...
		<tr>
            <th scope="row"><label for="homepage">해쉬테그</label></th>
            <td>
