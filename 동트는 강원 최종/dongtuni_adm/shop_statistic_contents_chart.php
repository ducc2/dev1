...
<div id="cont_right">
	...
	<div>
		...
		<tr>
            ...
            <td>
				<input type='button' value='Contents' id='chart_visit' class='button_white80x24' onclick="chart_state_choice('visit');"> 
				<input type='button' value='나도여행작가' id='chart_ip' class='button_white80x24' onclick="chart_state_choice('ip');">
            </td>
        </tr>        
		<tr>
