...
.board_button_right {display:block; overflow: hidden; padding: 7px 0 7px; text-align:right;}
...
<div id="cont_right">
	...
	<div class="board_view_top_left"><strong>작성자</strong> : <?=$name?></div>
	<div class="board_view_top_right"><strong>조회</strong> : <?=$hit?></div>
	...
	<div class="board_view_top_left">
	<strong>저작권</strong>  :   <? if ($extra_1==1) { ?>강원도<? } ?> <? if ($extra_1==2) { ?>외부<? } ?><br>
	<strong>호수</strong>  :   <?=$extra_2?>년 <?=$extra_3?>월호<br>
	<strong>주소</strong> : <?=$extra_5?>
	</div>
	
	<? } else { ?>
	<div class="board_view_top_left">
	<strong>연락처</strong>  :   <?=$extra_1?>-<?=$extra_2?>-<?=$extra_3?>
	</div>
	<? } ?>
