		...
		<table summary="글쓰기:작성자, 제목, " class="tblBbs">
				...
				<tbody>
					<tr>
						...
						<td class="left">
							<input type="text" style="width:200px;" name="name" title="이름" value="<?=$name_t?>" readonly="readonly">
							<!-- 강원도서포터즈면 -->
					...
					<tr>
						...
						echo $row['extra_1']."-".$row['extra_2']."-".$row['extra_3'];
							...
							<select name="extra_1" title="전화번호선택" style="height:24px;">
								...
								<input type="text" name="extra_2" class="phoneBox" title="전화번호입력" style="width:50px;" value="<?=$_POST['pphone2']?>" onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;" readonly="readonly"> -
								<input type="text" name="extra_3" class="phoneBox" title="전화번호입력" style="width:50px;" value="<?=$_POST['pphone3']?>" onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;" readonly="readonly">
							<? } ?>
							<!-- 강원도서포터즈면 -->
							<span class="tag_sup"><!-- 강원도서포터즈 --></span>
							<!-- //강원도서포터즈면 -->
