<?
       ...
       /******************** 인증정보 ********************/
        ...
        if ($fp) {
            ...
            //발송결과 알림
            if($Result=="success") {
                 $query = "insert into ".$tbname['tel']." set tel_content='".$_POST['msg']."',tel_to='".$_POST['rphone']."',tel_from='".$_POST['user_phone']."',tel_reg=NOW(),user_idx='".$_SESSION['ss_user_idx']."',apply_idx='".$_POST['apply_idx']."' ";
				$result = mysqli_query($mysqli, $query);

				echo "<script>opener.window.location.reload(); location.href='/sms.html';</script>";
				exit;
            }
